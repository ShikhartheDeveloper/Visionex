...
const PostCard = ({ post }) => {
  ...
  return (
    <Link
      ...
      className="group block relative rounded-2xl overflow-hidden mb-4 break-inside-avoid shadow-lg shadow-red-900/5 hover:-translate-y-1 hover:shadow-red-900/20 transition-all duration-500 cursor-zoom-in bg-white/5"
    >
      {/* Image */}
      <img
        src={post?.imageLink}
