            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="relative w-full md:w-72">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 focus:border-red-500 rounded-xl py-2 pl-10 pr-4 text-white placeholder-gray-400 focus:outline-none transition-colors"
                />
              </div>
            </div>
                      ...
                      users.map((u, index) => (
                        <tr key={u._id} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                          ...
                          <td className="py-4 px-4 text-right">
                            {u.isActive ? (
                              <button onClick={() => handleBanUnbanUser(u._id)} className="border border-red-500/50 text-red-400 hover:bg-red-500/10 px-3 py-1 rounded-full text-xs font-medium transition-colors">
                                Ban
                              </button>
                            ) : (
