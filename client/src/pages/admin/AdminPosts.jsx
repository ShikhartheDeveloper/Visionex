                        ...
                        <tr key={post._id} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                          ...
                          <td className="py-4 px-4 text-right">
                            {post.isPublished ? (
                              ...
                              <button onClick={() => handlePublishUnpublishPost(post._id)} className="border border-red-500/50 text-red-400 hover:bg-red-500/10 px-3 py-1 rounded-full text-xs font-medium transition-colors">
                                Publish
                              </button>
                            )}
                          </td>
