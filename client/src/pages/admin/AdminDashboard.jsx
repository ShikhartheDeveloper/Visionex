...
const AdminDashboard = () => {
  ...
  const statCards = [
    { label: 'Total Users', value: users?.length, icon: Users, color: 'text-red-500', border: 'border-b-red-500/50' },
    { label: 'Total Posts', value: posts?.length, icon: ImageIcon, color: 'text-orange-500', border: 'border-b-orange-500/50' },
    { label: 'Total Reports', value: reports?.length, icon: ShieldAlert, color: 'text-rose-500', border: 'border-b-rose-500/50' },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
              ...
              <div className="lg:col-span-2 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/admin/users" className="text-sm text-red-400 hover:text-red-300 transition-colors">
                    View All
                  </Link>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/admin/reports" className="text-sm text-red-400 hover:text-red-300 transition-colors">
                    View All
                  </Link>
                </div>
                    ...
                    reports.slice(0, 3).map((report) => (
                      <div key={report._id} className="glass-card p-4 hover:bg-white/5 transition-colors">
                        ...
                        <div className="flex items-center justify-between text-xs text-gray-500 mt-2">
                          ...
                          <Link className='p-2 bg-red-300 rounded-md text-black' to={`/auth/post/${report.post?._id}`}>View Post</Link>
                        </div>
                      </div>
                    ))
                  ) : (
