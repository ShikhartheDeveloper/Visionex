          ...
          <div className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto mt-4">
            ...
            {filteredPosts?.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-24 text-center gap-4">
                <Sparkles className="w-12 h-12 text-orange-500 opacity-40" />
                <h2 className="text-xl font-semibold text-white/60">Your feed is empty</h2>
                <p className="text-sm text-gray-500 max-w-xs">Follow other creators on <span className="text-orange-400 font-medium">Explore</span> to see their AI art here.</p>
              </div>
            )}
          </div>
        </main>
